...
class KnowledgeBuilder:
    ...
    def __init__(self, cfg: Config, embedder: EmbeddingStore):
        ...
        self.labeler = SemanticLabeler(cfg) if cfg.enable_semantic_labeling else None
...
def run(cfg: Config):
    ...
    if cfg.enable_semantic_labeling and kb.labeler:
        ...
        if len(kb.labeler.discovered) > 15:
            logger.info(f"  ... and {len(kb.labeler.discovered) - 15} more themes")
